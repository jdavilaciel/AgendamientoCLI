...
WebUI.callTestCase(findTestCase('0 Llenar datos Formulario (Usuario Nuevo)'), [:], FailureHandling.STOP_ON_FAILURE)
...
WebUI.selectOptionByLabel(findTestObject('CLI/1 Solicitar Cita/2 Escoger Cita/select_Tramite (Servicio)'), '4 - Área General - General (G) - Información', 
    false)
