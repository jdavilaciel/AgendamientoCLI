...
WebUI.click(findTestObject('CLI/3 Consultar Citas/2/chk_ 1 Seleccionar'))

WebUI.delay(3)

WebUI.comment('Boton Enviar email')

WebUI.click(findTestObject('CLI/3 Consultar Citas/2/btn_Enviar (EMail)'))

WebUI.delay(3)

WebUI.takeFullPageScreenshot()

WebUI.comment('Boton ver detalle de la primera cita')

WebUI.delay(3)

WebUI.click(findTestObject('CLI/3 Consultar Citas/2/btnVerDetalle1'))
